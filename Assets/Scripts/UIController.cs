...
public class UIController : MonoBehaviour
{
    ...
    public void displayTime(float timeToDisplay)
    {
        ...
        // Debug.Log("t: " + t + " displaytime: " + timeToDisplay + " tRatio: " + tRatio + " color: " + time.color);
        // Debug.Log("initialColor: " + initialColor + " finalColor: " + finalColor + " lerpColor: " + lerpColor);

        if (minutes <= 1) // font becimes bold when a minute is left
        {
            time.fontStyle = FontStyle.BoldAndItalic;
        } else 
        {
            time.fontStyle = FontStyle.Italic;
        }
    }
