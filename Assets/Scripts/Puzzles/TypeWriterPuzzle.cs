...
public class TypeWriterPuzzle : Puzzle
{
    ...
    private readonly List<SecretObjectiveID> broadcastedObjectives = new();

    [Header("Puzzle")] [Tooltip("This defines the possible puzzle solutions.")]
    private readonly Dictionary<ButtonType, string> ButtonToString = new()
    {
        { ButtonType.Submit, "" },
        { ButtonType.A, "A" },
        { ButtonType.B, "B" },
    ...
    private void Start()
    {
        ...
        var solution = GameController.Instance.puzzles[GameController.Instance.currentRound].solution;
    ...
    public void ButtonPressed(Button button)
    {
        ...
        if (_answer.Length == 0) puzzle_text.text = "";
        ...
        {
            var s = new SecretObjectiveEvent();
